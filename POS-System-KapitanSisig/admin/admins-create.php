        ...
        <div class="card-body">
           ...
           <form action="code.php" method= "POST">
            <div class="row">
                ...
                <div>
                    <input type="checkbox" name="position" value="1" <?= $adminData['data']['position'] == 1 ? 'checked' : ''; ?>>
                    <label>Owner</label>
                </div>
                <div>
                    <input type="checkbox" name="position" value="0" <?= $adminData['data']['position'] == 0 ? 'checked' : ''; ?>>
