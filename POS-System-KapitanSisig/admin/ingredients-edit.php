    ...
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h4 class="mb-0">Edit Ingredient
                <a href="ingredients-view.php" class="btn btn-primary float-end">Back</a>
            </h4>
        </div>
        <div class="card-body">
            <?php
            ...
            <form action="code.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" id="quantity" name="quantity" value="<?= htmlspecialchars($ingredient['quantity']) ?>" class="form-control" required>
                </div>
